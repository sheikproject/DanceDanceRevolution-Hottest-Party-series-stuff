...
# Notes
The hex editor included in the tool doesn't show the entire file, use an actual hex editor like <strong>HxD</strong> or <strong>010 Editor</strong> to view the entire file data.
